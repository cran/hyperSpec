...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{fig/fig-tsextra}
...
\begin{figure}[tbh]
  \centering
  \subfloat[\label{fig:row}]{\includegraphics[width=.5\textwidth]{fig/fig-plotmatr}}
  \subfloat[\label{fig:t}]{\includegraphics[width=.5\textwidth]{fig/fig-plotmatt}}  
