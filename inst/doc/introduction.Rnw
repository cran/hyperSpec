...
\warnbox{Deprecated}{The logbook is now DEPRECATED and the functionality will be removed in the future.\\
  This feature has never seen much use, but slows down \phy considerably.}
...
transformed. This is now the default setting of the option as the logbook is deprecated and will be
completely removed.
